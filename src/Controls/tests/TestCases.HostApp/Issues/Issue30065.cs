...
public class Issue30065 : ContentPage
{
	public Issue30065()
	{
		...
		{
			rtlDatePicker.FlowDirection = rtlDatePicker.FlowDirection == FlowDirection.RightToLeft
	? FlowDirection.LeftToRight
	: FlowDirection.RightToLeft;

			ltrDatePicker.FlowDirection = ltrDatePicker.FlowDirection == FlowDirection.RightToLeft
	? FlowDirection.LeftToRight
	: FlowDirection.RightToLeft;
		};
